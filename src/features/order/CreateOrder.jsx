...
import { clearCart, getCart, getTotalCartPrice, getUser } from "../cart/cartSlice";
    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center relative">
          ...
          {
            !position.latitude && !position.longitude && (<span className="absolute right-[3px] z-10 top-[3px] md:top-[5px] sm:right-[5px]">
            <Button
              disabled={isLoadingAddress}
        ...
        <div>
          ...
          <Button disabled={isSubmitting || isLoadingAddress} type='primary' >
            {isSubmitting ? "Placing order..." : `Order nowfor ${formatCurrency(totalPrice)}`}
          </Button>
        </div>
      </Form>
    </div>
